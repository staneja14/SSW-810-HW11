...
This Python program is implementation of Homework 10
...
class Repository:
    ...
    def __init__(self, directory, pt=False):
...
def instructor_table_DB(self):
    DB_FILE = "/Users/shivani/Desktop/Python%assignments//810_startup.db"
...
def main():
    ...
    repository_1 = Repository(r'Users\shivani\Desktop\Pythonassignments', pt=True)
